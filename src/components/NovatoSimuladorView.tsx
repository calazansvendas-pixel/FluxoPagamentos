...
// Visão simplificada da Ficha Morar (tela "Simulador Simplificado" no menu
// lateral — ver config/telasApp.ts e App.tsx). Mesmo "papel" (visual de folha
// A4) e os mesmos dados já calculados pelo motor em FichaMorar.tsx — só uma
  ...
  return (
    <div className="space-y-4 max-w-4xl mx-auto pb-12">
      ...
      <div className="bg-white p-6 sm:p-7 rounded-xl shadow-md border border-slate-200 w-full text-slate-900 space-y-3.5">
        ...
        {/* 2. RESUMO DA UNIDADE — Torre/Unidade viram seletores compactos
            (largura fixa e pequena — só cabe a letra da torre / número da
            unidade), com o espaço redistribuído para Fase/Tipologia via flex. */}
        <div className="bg-white p-3 rounded-xl border border-slate-200 space-y-2 overflow-hidden w-full">
          <div className="flex flex-wrap items-stretch gap-2 text-xs w-full">
            <div className="flex-none w-[4.5rem] max-w-[4.5rem] bg-[rgba(240,249,255,0.6)] p-2 rounded-lg border border-morar-200 min-w-0 relative">
              ...
              <select
                ...
                className="w-full bg-white text-slate-900 font-bold text-xs rounded-md border border-morar-200 px-1 py-1 cursor-pointer focus:outline-none focus:ring-2 focus:ring-morar-300"
              >
                <option value="">-</option>
            ...
            <div className="flex-none w-[4.5rem] max-w-[4.5rem] bg-[rgba(240,249,255,0.6)] p-2 rounded-lg border border-morar-200 min-w-0 relative">
              ...
              <select
                ...
                className="w-full bg-white text-slate-900 font-bold text-xs rounded-md border border-morar-200 px-1 py-1 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-morar-300"
              >
                <option value="">-</option>
